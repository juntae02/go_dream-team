...
#ifndef TURTLEBOT3_GAZEBO__BARRIER1_CLONE_PLUGIN_HPP_
#define TURTLEBOT3_GAZEBO__BARRIER1_CLONE_PLUGIN_HPP_
...
namespace gazebo
{
class Barrier1ClonePlugin : public ModelPlugin
{
public:
  Barrier1ClonePlugin();
  void Load(physics::ModelPtr _model, sdf::ElementPtr _sdf) override;
...
GZ_REGISTER_MODEL_PLUGIN(Barrier1ClonePlugin)
}  // namespace gazebo

#endif  // TURTLEBOT3_GAZEBO__BARRIER1_CLONE_PLUGIN_HPP_
