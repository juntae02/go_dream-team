...
- **문제 상황 3: 횡단보도와 차선의 구별을 못하는 경우 발생**
  - **상황** : 횡단보도 또한 밝은 색상이라 일반 차선과 구별하기 어려운 문제가 발생했습니다. 
    
  - **원인** : 두 객체 모두 밝은 색상이 존재해 단일 정보인 밝기만으로는 시각적 특성을 분리하기 어려웠습니다.
    
  - **해결** : **색상 정보를 보조적인 판단 기준으로 활용**하여 밝기 정보의 한계를 보완하고, 횡단보도를 감지 시 **정지 기능**을 구현했습니다.   
